...
<ul class="pagination">
    <li <?php echo($D->npage == 1?'class="disabled"':''); ?>>
		<?php if ($D->npage != 1) { ?><a href="<?php echo $K->SITE_URL?>ss-admin/products/p:<?php echo($D->npage-1); ?>"><?php } ?>
        <span>&laquo;</span>
    ...
    <li <?php echo($D->npage == $i?'class="active"':''); ?>>
    	<?php if ($D->npage != $i) { ?><a href="<?php echo $K->SITE_URL?>ss-admin/products/p:<?php echo $i; ?>"><?php } ?>
    ...
    <li <?php echo($D->npage == $D->totalpages?'class="disabled"':''); ?>>
    	<?php if ($D->npage != $D->totalpages) { ?><a href="<?php echo $K->SITE_URL?>ss-admin/products/p:<?php echo($D->npage+1); ?>"><?php } ?>
        <span>&raquo;</span>
